...
// ProdukcjaMonitor.cpp: definiuje zachowania klasy dla aplikacji.
//
...
BEGIN_MESSAGE_MAP(CProdukcjaMonitorApp, CWinApp)
	ON_COMMAND(ID_HELP, &CWinApp::OnHelp)
END_MESSAGE_MAP()


// Konstrukcja klasy CProdukcjaMonitorApp

CProdukcjaMonitorApp::CProdukcjaMonitorApp()
{
...
// Jedyny obiekt CProdukcjaMonitorApp

CProdukcjaMonitorApp theApp;


// Inicjowanie klasy CProdukcjaMonitorApp

BOOL CProdukcjaMonitorApp::InitInstance()
{
